...
$script:Strings = @{
    'en' = @{
        ...
        SigNoneAssigned    = '(no signature assigned)'
        LblLocalSignatures = 'LOCAL SIGNATURES'
        SigPreviewFailed   = 'Preview failed: {0}'
        SigSelectFirst     = 'Click a signature name in the left panel first.'
        SigNoAccounts      = 'No Outlook accounts found.'
        SigSelectToPreview = 'Select a mailbox or signature to preview.'
        # Permissions tab
        ...
        OverviewNoCustomPerms = 'No custom permissions'
    ...
    'de' = @{
        ...
        SigNoneAssigned    = '(keine Signatur zugewiesen)'
        LblLocalSignatures = 'LOKALE SIGNATUREN'
        SigPreviewFailed   = 'Vorschau fehlgeschlagen: {0}'
        SigSelectFirst     = 'Bitte zuerst einen Signaturnamen im linken Bereich auswählen.'
        SigNoAccounts      = 'Keine Outlook-Konten gefunden.'
        SigSelectToPreview = 'Postfach oder Signatur auswählen, um eine Vorschau anzuzeigen.'
        # Permissions tab
        ...
        OverviewNoCustomPerms = 'Keine benutzerdefinierten Berechtigungen'
